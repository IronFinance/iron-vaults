...
contract VaultQuickswapLP is VaultBase {
    ...
    constructor(address _liquidityRouter, IQuickswapStakingRewards _stakingRewards) VaultBase() {
        liquidityRouter = _liquidityRouter;
        stakingRewards = _stakingRewards;
        wantAddress = stakingRewards.stakingToken();
    ...
    function _depositToFarm() internal canDeposit {
        ...
        wantToken.safeIncreaseAllowance(address(stakingRewards), wantAmt);
